...
exports.getMaticGasPrice = void 0;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                safeLowGasPrice = ethers_1.ethers.utils.parseUnits(response.data.safeLow.maxPriorityFee.toString(), 9);
                standardGasPrice = ethers_1.ethers.utils.parseUnits(response.data.standard.maxPriorityFee.toString(), 9);
                fastGasPrice = ethers_1.ethers.utils.parseUnits(response.data.fast.maxPriorityFee.toString(), 9);
